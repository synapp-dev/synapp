...
function AuthFormContent() {
  ...
  useEffect(() => {
    ...
    setAlert({
      ...
      description:
        messages[err] ?? decoded ?? "Authentication error. Try again.",
      tone: "error",
    });
  }, [searchParams]);
        ...
        <CardContent className="grid min-h-[30rem] p-0 md:grid-cols-2">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    disabled={
                      isSubmitting || isOtpStep || awaitingEmailConfirmation
                    }
                  />
                </div>
          ...
          <div className="bg-muted relative hidden flex-col items-center justify-center overflow-hidden md:flex">
            ...
            <div className="relative z-10 px-10 text-center">
              <p className="text-primary text-lg font-semibold">Youth Justice</p>
