/**
 * Topic Slide Image URL API route handler.
 *
 * Exposes HTTP endpoints for getting signed URLs for topic slide images.
 *
 * Authentication:
 ...
 *
 * Endpoints:
 * - GET /api/topic-slides/[id]/url - Get signed URL for slide image
 *
 * Responses:
...
/**
 * Handle GET /api/topic-slides/[id]/url
 *
 * Returns a signed URL for the slide image with 1-week expiry.
...
export async function GET(
  ...
  try {
    ...
    const result = await topicsService.getSlideImageUrl({ userId }, id);
