/**
 * Curriculum Stage by Code API route handler.
 *
 * Exposes HTTP endpoints for specific curriculum stage management by code.
 *
 * Authentication:
 ...
 *
 * Endpoints:
 * - GET /api/curriculum/stages/by-code/[code] - Get curriculum stage by code
 *
 * Responses:
...
/**
 * Handle GET /api/curriculum/stages/by-code/[code]
 *
 * Returns a specific curriculum stage's information by code.
 *
...
export async function GET(
  ...
  try {
    ...
    const stageData = await curriculumService.getStageByCode({ userId }, { code });
