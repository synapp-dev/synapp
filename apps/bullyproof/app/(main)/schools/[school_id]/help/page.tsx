  ...
  const helpArticles = [
    {
      ...
      description: "Complete guide to configuring your school's information and settings",
    ...
    },
    {
      ...
      description: "Step-by-step instructions for managing your school's user accounts",
      category: "Getting Started",
      type: "video",
      readTime: "8 min",
      difficulty: "beginner",
    ...
    },
    {
      ...
      description: "Best practices for designing engaging and impactful lessons",
    ...
    },
    {
      ...
      description: "Creating comprehensive reports for administrators and stakeholders",
      category: "Best Practices",
      type: "article",
      readTime: "10 min",
      difficulty: "intermediate",
    ...
    <div className="space-y-6">
        ...
        <CardContent>
          <div className="space-y-4">
            {helpArticles.map((article) => {
              ...
              return (
                <div key={article.id} className="flex items-start space-x-4 p-4 border rounded-lg hover:bg-gray-50">
                ...
                <Card key={option.id} className="hover:shadow-md transition-shadow cursor-pointer">
                  ...
                  <CardContent className="pt-0 space-y-2">
                    ...
                    <Button size="sm" className="w-full mt-2">
                      {option.name === "Live Chat" ? "Start Chat" : 
                       option.name === "Email Support" ? "Send Email" : "Call Now"}
                    </Button>
                  </CardContent>
                </Card>
              );
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Popular resources and downloads
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-muted-foreground">System status updates</p>
              <Button size="sm" variant="outline" className="w-full">
                Check Status
              </Button>
            </div>
