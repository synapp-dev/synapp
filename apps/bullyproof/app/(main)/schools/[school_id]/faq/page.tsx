  ...
  const faqItems = [
    {
      ...
      answer: "To add new teachers, go to the Teachers page and click 'Invite Teacher'. Enter their email address and they will receive an invitation to join your school. You can also bulk import teachers using our CSV template.",
    ...
    {
      id: 3,
      question: "How can I track my school's anti-bullying program effectiveness?",
      answer: "Use the Performance dashboard to monitor key metrics like incident rates, student engagement, and lesson completion. Generate monthly reports to track trends over time. The system provides automated insights and recommendations for improvement.",
    ...
    },
    {
      ...
      answer: "Navigate to the Classes page and click 'Add Class'. Enter class details like name, grade level, and teacher. Students can be added individually or imported via CSV. You can also sync with your existing student information system.",
    ...
    },
    {
      ...
      answer: "The Resources section contains videos, worksheets, presentations, and interactive materials. Filter by grade level, subject, or type. All resources are curriculum-aligned and include teacher guides. You can also upload your own materials.",
      category: "Getting Started",
      helpful: 27,
    ...
    },
    {
      ...
      answer: "Go to the Reports page and select your desired report type (bullying trends, engagement, teacher performance). Choose date ranges and filters, then click 'Generate Report'. Reports can be exported as PDF or shared via email.",
      category: "Reports & Analytics",
      helpful: 19,
    ...
    },
    {
      ...
      answer: "Yes, parents can be given limited access to view their child's progress and receive notifications about incidents. You can control what information parents can see in the Settings page under Parent Portal configuration.",
      category: "User Management",
      helpful: 15,
    ...
    },
    {
      ...
      answer: "Go to Settings > Notifications to configure email alerts, incident notifications, and weekly reports. You can set different notification preferences for teachers, administrators, and parents.",
      category: "User Management",
      helpful: 21,
                ...
                <AccordionItem key={item.id} value={`item-${item.id}`}>
                  ...
                  <AccordionContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-xs text-muted-foreground">{item.helpful} found helpful</span>
