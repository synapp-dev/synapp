-- Update v_feature_permissions_readable to include visible column
DROP VIEW IF EXISTS v_feature_permissions_readable;

CREATE VIEW v_feature_permissions_readable AS
SELECT 
  fp.id,
  fp.feature_id,
