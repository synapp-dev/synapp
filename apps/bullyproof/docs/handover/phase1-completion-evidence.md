...
| 44 - Remove Ctrl+K menu | Command menu mounted in header | `ba8fb12` | `CommandMenu` mount and import removed from `app-header.tsx`; light/dark toggle retained |
...
| 47 - Reports "available soon" message | - | verified done | School reports page shows "Coming Soon - available after Term 1" |
